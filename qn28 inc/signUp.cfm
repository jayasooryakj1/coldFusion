    ...
    <div class="d-flex justify-content-center">
        <div class="w-50 bg-white text-center mt-5 text-center pb-5">
            <form action="" method="post" class="mt-5 mb-5">
                ...
                <input type="radio" name="role" id="admin" value="Admin">&nbsp; Admin <br>
                <input type="radio" name="role" id="editor" value="Editor">&nbsp; Editor <br>
                <input type="radio" name="role" id="user" value="User">&nbsp; User <br>
