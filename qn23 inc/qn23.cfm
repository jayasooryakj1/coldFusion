...
<body>
        ...
        <div class="mainBody w-50 p-3">
            <form action="" method="post">
                ...
                <div class="salary mt-3">
                    ...
                    <div class="mt-3">
                        <span>$</span>
                        <span><input class="dollar" name="salaryDollar" id="salaryDollar" type="number"></span>
                        <span>.</span>
                        <span><input class="cents" name="salaryCent" id="salaryCent" type="nujmber"></span>
                        <br>
                        <div class="salDen">
    ...
    <div>
        <cfif structKeyExists(form, "submit")> 
            ...
            <cfset local.user[salary] = "#form.salaryDollar#" + ("#form.salaryCent#"/100)>
